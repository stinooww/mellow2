        ...
        return (
            <div>
                <Grid className="dicomenu-service">
                    ...
                    <Row>
                        <Col md={4} sm={12}> <div data-aos="fade-up"  data-aos-easing="ease-in-out" data-aos-duration="1500">  <Image  src={ober} alt="dicomenu" rounded responsive className="img"/></div>
                        </Col>
                        <Col md={4} sm={12}><div data-aos="fade-up"  data-aos-easing="ease-in-out"
                                                 data-aos-duration="1500"> <Image src={koppel} alt="dicomenu" rounded responsive className="img"/></div>
                        </Col>
                        <Col md={4} sm={12}> <div data-aos="fade-up"  data-aos-easing="ease-in-out" data-aos-duration="1500"><Image src={waterschenken} alt="dicomenu" rounded responsive className="img"/></div>
                        </Col>
                    </Row>
                    ...
                    <Row>
                        <Col className="webhosting" data-aos="zoom-in-up"  data-aos-delay="1250">
                            ...
                            <p>We hebben de volledige website vervolgens overgezet naar onze webhosting server en dit resulteerde in een laadtijd van bijna <strong>3,5 seconde</strong> sneller !!!</p>
