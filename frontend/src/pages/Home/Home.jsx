                        ...
                        <Row className="show-grid ">
                            <Col xs={12} md={12} className="person-wrapper">
                                ...
                                <Carousel className="testimonial-carousel" interval={7500}>
                                    <CarouselItem>
                                        <Testimonials naam="Rita - Dicomenu" text="Vol nieuwe ideeën, dynamisch, vriendelijk, opbouw met
                                                respect voor de mogelijkheden. Steeds vernieuwend. Super
                                                toffe jonge mensen waarop je altijd kan rekenen." text2="Mellow webdesign is een echte aanrader, en wij kunnen
                                                het weten want we werken al een hele tijd samen."/>
                                    </CarouselItem>
                                    <CarouselItem>
                                        <Testimonials naam="Anja - Body Update" text=" Goede communicatie, vernieuwde kijk op zaken gekregen,
