        ...
        <Grid>
          <Row>
            ...
            <Col xs={12} className="onderhoud__expl">
              <p>
                Een website maken stopt niet bij de ontwikkeling ervan. Ook na
                de lancering is het belangrijk dat je website goed wordt
                onderhouden. Hiervoor bieden we een onderhoudspakket aan. Dit is
                nodig omdat in de website verschillende plugins steken die
                zorgen voor allerlei functionaliteit van de website. Deze moeten
                op regelmatige basis worden geupdate zodat ze goed kunnnen
                blijven werken.
              </p>

              <p>
                Ook zorgen we ervoor dat je website beschermt is tegen hackers
                om te voorkomen dat cyberaanvallen je website offline halen. We
                nemen bovendien regelmatig een backup zodat we altijd een kopie
                hebben van de inhoud je website en deze dus nooit verloren kan
                gaan.
              </p>
              <p>
                {' '}
                ...
                veranderen, of dat stukje tekst over jezelf aanpassen. Dit doen
                we kosteloos!
              </p>
            </Col>
