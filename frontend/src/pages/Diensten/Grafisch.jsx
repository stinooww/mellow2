          ...
          <Row className="marketingEmail">
            ...
            <Col md={6} xs={12} data-aos="zoom-out-left">
              <p>
                ...
                e-mail marketing. Denk bijvoorbeeld aan een nieuwsletter van je
                bedrijf, of om je producten en of kortingsacties hierop aan te
                prijzen.
              </p>
              <br />
              <p>
                E-mails versturen kan op heel wat manieren: een klassiek
                berichtje of een een campagnemail met jouw logo en volledig in
                de stijl van je branding. Wij voegen hierbij stukjes code zodat
                de emails slimmer worden en je kan nagaan bijvoorbeeld wie de
                emails opent, waar en wanneer er wordt doorgeklikt.
              </p>
              <br />
              <p>
                Dit is zonder meer interessant om te kijken wat werkt en wat
                niet. Dit om jouw meer business op te leveren.
                <br />
                <br />
