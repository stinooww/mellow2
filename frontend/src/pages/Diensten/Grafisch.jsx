        ...
        <Row>
          ...
          <Col md={5} xs={12}>
            <p>
              ...
              marketing. Denk bijvoorbeeld aan een nieuwsletter van je bedrijf,
              of om je producten en of kortingsacties hierop aan te prijzen.
            </p>
            <br />
            <p>
              Deze e-mails als campagnemail met jouw logo en volledig in de
              stijl van je branding. Wij voegen hierbij stukjes code zodat de
              e-mails slimmer worden en je kan nagaan wie de emails opent en
              waar / wanneer er wordt doorgeklikt.
            </p>
            <br />
            <br />
          </Col>
