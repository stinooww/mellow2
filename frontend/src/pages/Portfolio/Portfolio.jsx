                            ...
                            <div className="image-cell-container">
                              <a href="https://mmehospitality.nl/project/mmes-scout-dagen/">
                                <figure
                                  ...
                                  style={{
                                    backgroundImage:
                                      "url('https://mmehospitality.nl/wp-content/uploads/2019/03/project-190321-dior-instore-event-1-min.jpg ')"
                                  }}
                                >
                                  <span className="aspect-ratio" />
                                </figure>
                          ...
                          <div className="cell content-cell">
                            <div className="content-cell-container">
                              <div>
                                <h2 className="title">
                                  <a
                                    href="https://mmehospitality.nl/project/mmes-scout-dagen/"
                                    rel="bookmark"
                                  >
                                    MME’S Scout Dagen
                                  </a>
                                ...
                                <h3 className="client">
                                  <a href="https://mmehospitality.nl/client/mme-hospitality/">
                                    MME Hospitality
                                  </a>
                                </h3>
                              </div>
