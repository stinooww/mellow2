  ...
  <Grid className="StrategiePage">
    <Row>
      <Col xs={12} className="StrategiePage__intro">
        ...
        <p>
          Onze strategie is opgedeeld in verschillende fases om zo uw ideëen om
          te zetten in een geweldig en professioneel eindproduct dat meerwaarde
          creëert voor uw zaak.
        </p>
