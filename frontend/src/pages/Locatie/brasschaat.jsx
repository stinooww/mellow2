...
class brasschaat extends Component {
  render() {
    return (
      <Grid className="locaties">
        <Row>
          <Col md={12} className="locaties__head text-center">
            <h1>Website laten maken in Brasschaat</h1>
            <h2>Wij bouwen uw professionele website in Brasschaat</h2>
          </Col>
        </Row>
        <Row>
          <Col md={12} className="locaties__intro">
            <p>
              Wil je graag een nieuwe website laten maken in Brasschaat of ben
              je op zoek naar een nieuw webdesign bedrijf uit Brasschaat om mee
              samen te werken?
            </p>
            <p>
              Kies dan voor Mellow webdesign development, een web agency uit
              Edegem gespecialiseerd in het maken van professionele en
