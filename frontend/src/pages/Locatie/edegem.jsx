...
class edegem extends Component {
  render() {
    return (
      <Grid className="locaties">
        <Row>
          <Col md={12} className="locaties__head text-center">
            <h1>Website laten maken in Edegem</h1>
            <h2>Wij bouwen uw professionele website in Edegem</h2>
          </Col>
        </Row>
        <Row>
          <Col md={12} className="locaties__intro">
            <p>
              Wil je graag een nieuwe website laten maken in Edegem of ben je op
              zoek naar een nieuw webdesign bedrijf uit Edegem om mee samen te
              werken?
            </p>
            <p>
