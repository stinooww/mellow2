...
class wilrijk extends Component {
  render() {
    return (
      <Grid className="locaties">
        <Row>
          <Col md={12} className="locaties__head text-center">
            <h1>Website laten maken in Wilrijk</h1>
            <h2>Wij bouwen uw professionele website in Wilrijk</h2>
          </Col>
        </Row>
        <Row>
          <Col md={12} className="locaties__intro">
            <p>
              Wil je graag een nieuwe website laten maken in Wilrijk of ben je
              op zoek naar een nieuw webdesign bedrijf uit Wilrijk om mee samen
              te werken?
            </p>
            <p>
