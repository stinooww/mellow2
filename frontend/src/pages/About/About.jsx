            ...
            <div className="post__content">
              <div>
                ...
                <h2 className="post__header">
                  <span>Hoe het</span> <span>allemaal</span> <span>begon</span>
                </h2>
              </div>
              <p className="post__text">
                ...
                richting Multimedia technologie. Tijdens hun opleiding kregen ze
                meer en meer de vraag van andere ondernemers naar betaalbare
                maar nog steeds professionele websites.
              </p>
              <br />
              <p>
              ...
              <p>
                ...
                onze klanten en meerdere keren samenzitten zodat wij hun een op
                maat gemaakt product kunnen afleveren.
              </p>
              <br />
              <p>
                ...
                onderneming. Hierin bedoelen we dus het technologische zoals
                websites, web applicaties, online marketing maar ook de design
                kant zoals logos, banners en flyers.
              </p>
            </div>
          </div>
        </article>
